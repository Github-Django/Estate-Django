jQuery(function($){
		...
		$('.owl-carousel').each(function(){
			...
			carouselInstance.owlCarousel({
				...
				responsive: {
					...
					768:{
						items: carouselitemsDesktopSmall
					},
					992:{
				...
				onInitialized: function(){
					$(".property-featured-image").each(function(){
						...
						$(this).find("div.overlay").css('line-height', PIheight+'px');
					});
				}
			});
		});
   ...
   SuperFish menu
	...
	REAL.SuperFish = function() {
		...
		$(".navigation > ul > li > ul > li:has(ul)").find("a:first").append(" <i class='fa fa-caret-left'></i>");
	}
	/* ==================================================
   IsoTope Portfolio
	================================================== */
   ...
   Init Functions
	...
	$(".block-heading").each(function(){
		$(this).find('.heading-icon').prepend('<i class="fa fa-caret-left icon-design"></i>');
	});
	$(".property-featured-image").each(function(){
		PIheight = $(this).find("img").outerHeight();
	...
	$('#ads-trigger').click(function () {	
		if ($(this).hasClass('advanced')) {
			...
			$(this).html('<i class="fa fa-plus"></i> پیشرفته');
			...
			$(this).html('<i class="fa fa-minus"></i> پایه‌ای');
	...
	$('ul.angles li, .nav-list-primary li a').prepend('<i class="fa fa-angle-left"></i> ');
	$('ul.inline li').prepend('<i class="fa fa-check-circle-o"></i> ');
	$('ul.chevrons li').prepend('<i class="fa fa-chevron-left"></i> ');
	$('ul.carets li').prepend('<i class="fa fa-caret-left"></i> ');
