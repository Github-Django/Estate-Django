...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='article',
            name='description',
            field=models.TextField(blank=True, help_text='در توضیحات آگهی به مواردی مانند شرایط اجاره، جزئیات و ویژگی\u200cهای قابل توجه، امکانات ملک اشاره کنید.', null=True, verbose_name='توضیحات'),
        ),
        migrations.AlterField(
            model_name='article',
